...
public class Basic3 {
		...
		@Test(priority=5)
		void tooltip5() throws InterruptedException {
			...
			@Test(priority=6)
			void tooltip6() throws InterruptedException {
			...
			@Test(priority=7)
			void tooltip7() throws InterruptedException {
			...
			@Test(priority=9)
			void tooltip8() throws InterruptedException {
